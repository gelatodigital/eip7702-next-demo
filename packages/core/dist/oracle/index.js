...
export const isOracleActive = async (chainId) => {
    const oracles = await getGelatoOracles();
    return oracles.includes(chainId.toString());
};
export const getGelatoOracles = async () => {
    try {
...
export const getPaymentTokens = async (chainId) => {
    try {
...
export const getEstimatedFee = async (chainId, paymentToken, gasLimit, gasLimitL1) => {
